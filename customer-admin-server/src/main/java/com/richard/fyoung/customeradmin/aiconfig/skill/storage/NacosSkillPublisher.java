 ...
 * 仅 {@code admin.skill.storage.nacos.enabled=true} 时注册。</p>
...
public class NacosSkillPublisher implements SkillContentPublisher {
    ...
    private final SkillStorageProperties.Nacos config;
    private volatile ConfigService configService;

    public NacosSkillPublisher(SkillStorageProperties.Nacos config) {
        this.config = config;
    }

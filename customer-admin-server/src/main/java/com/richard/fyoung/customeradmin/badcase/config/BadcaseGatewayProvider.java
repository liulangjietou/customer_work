 ...
 *
 * <p>连接参数复用 {@link CustomerWorkDbProperties}——badcase 与内容风控三表同在客服端库，
...
public class BadcaseGatewayProvider {
    ...
    public BadcaseGatewayProvider(CustomerWorkDbProperties properties, AdminCrossDbTenantPlugins tenantPlugins) {

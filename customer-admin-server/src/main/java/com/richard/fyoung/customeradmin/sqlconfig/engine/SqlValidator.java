 ...
 * {@link com.richard.fyoung.customerwork.infra.sqlkit.SqlValidator}（两侧唯一实现，避免规则双份维护）。
 *
...
public final class SqlValidator {
    ...
    public static void validateReadOnly(String sql) {
        try {
            com.richard.fyoung.customerwork.infra.sqlkit.SqlValidator.validateReadOnly(sql);

 ...
 * 客服端库主体配额门面的惰性提供者。
 *
 * <p>连接参数复用 {@link CustomerWorkDbProperties}——这些表与内容风控三表、租户配额同在客服端库，
...
public class SubjectQuotaGatewayProvider {
    ...
    public SubjectQuotaGatewayProvider(CustomerWorkDbProperties properties, AdminCrossDbTenantPlugins tenantPlugins) {

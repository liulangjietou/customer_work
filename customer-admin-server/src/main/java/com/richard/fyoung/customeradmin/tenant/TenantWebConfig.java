 ...
 *
 * <p>{@code matchIfMissing = true} 必须与 {@link AdminTenantProperties#isEnabled()} 的默认值一致：
 * 若这里缺省不装、而持久层按 Java 默认值装了 SQL 拦截器，每个请求都会缺租户上下文而 fail-closed。</p>
 * @author owlzhangfq@gmail.com
 */
@Configuration
@ConditionalOnProperty(prefix = "admin.tenant", name = "enabled", havingValue = "true", matchIfMissing = true)

...
class NacosSkillPublisherIntegrationTest {
    ...
    void publishThenGetThenRemove() throws Exception {
        ...
        SkillStorageProperties.Nacos config = new SkillStorageProperties.Nacos();
    ...
    private String awaitConfig(ConfigService verifier, String dataId, SkillStorageProperties.Nacos config,
    ...
    private Properties buildProperties(SkillStorageProperties.Nacos config) {

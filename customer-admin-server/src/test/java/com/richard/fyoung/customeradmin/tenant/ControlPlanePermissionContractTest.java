...
class ControlPlanePermissionContractTest {
    ...
    void controlPlaneEndpoints_shouldKeepPermissionPointAnnotations() {
        List<Contract> contracts = List.of(
            ...
            contract(BillingController.class, "forecast", "billing:view"),
            contract(BillingController.class, "listAlerts", "billing:view"),
            contract(BillingController.class, "acknowledgeAlert", "billing:view"),
            contract(BillingController.class, "export", "billing:export"),
            contract(BillingController.class, "aggregate", "billing:aggregate"),

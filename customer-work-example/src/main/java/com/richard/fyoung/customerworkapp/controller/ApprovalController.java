...
public class ApprovalController {
    ...
    public ApprovalController(PendingApprovalService approvalService) {
    ...
    public Mono<ApprovalRequest> approve(@PathVariable String id,
        ...
        return Mono.fromCallable(() -> approvalService.approve(id, operator))
    ...
    public Mono<ApprovalRequest> deny(@PathVariable String id,
        ...
        return Mono.fromCallable(() -> approvalService.deny(id, operator, note))
            .onErrorMap(this::translate);
    }

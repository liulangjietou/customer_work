...
> 包名：`com.richard.fyoung.customerwork` ｜ 协议：Apache-2.0 ｜ 文档与代码保持一致（ga2.0 共 384 个测试全绿：starter 362 + app 13 + downstream 1 + customer-web 8；独立的 `customer-admin-server` 后台管理系统另有 127 个全绿）
...
> 📌 本文是 `ga2.0` 分支（AgentScope 2.0）的深度架构文档。1.x→2.0 的逐项 API 映射、不可迁移能力见

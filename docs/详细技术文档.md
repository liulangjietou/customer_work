...
> 包名：`com.richard.fyoung.customerwork` ｜ 协议：Apache-2.0 ｜ 文档与代码保持一致（rc2.0 共 219 个测试全绿：starter 202 + example 9 + downstream 1 + customer-web 7）
...
[`customer-work-example/src/main/resources/application-prod.yml`](../customer-work-example/src/main/resources/application-prod.yml)。

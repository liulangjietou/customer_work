...
> 包名：`com.richard.fyoung.customerwork` ｜ 协议：Apache-2.0 ｜ 文档与代码保持一致（rc2.0 共 219 个测试全绿：starter 202 + app 9 + downstream 1 + customer-web 7）
...
`rc2.0` 分支已对照 `agentscope-java` 框架当时的 120 个 open issues 做过一轮全量交叉核对，结论沉淀在

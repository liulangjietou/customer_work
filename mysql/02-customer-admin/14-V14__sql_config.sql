...
-- =============================================================================
-- 采用"数据源 + 可参数化 SQL + 参数元数据 + 列转换器"四表模型，落地一个
-- 通用查询能力：管理员配置外部只读数据源与命名参数 SQL（:param），前端按 defineKey 渲染
-- 参数表单执行查询返回动态列结果。有意裁剪（不引入重型服务端渲染包袱）：
...
INSERT INTO `sql_define_param` (`id`, `define_id`, `param_name`, `param_desc`, `param_type`, `required`, `default_value`, `drop_down`, `is_page_num`, `is_page_size`, `sort`, `create_by`, `create_time`, `update_by`, `update_time`, `deleted`) VALUES (1, 1, 'startTime', '', 'STRING', 0, '${now-14d}', '', 0, 0, 0, 1, '2026-07-14 16:00:54', 1, '2026-07-14 16:00:54', 0);
INSERT INTO `sql_define_param` (`id`, `define_id`, `param_name`, `param_desc`, `param_type`, `required`, `default_value`, `drop_down`, `is_page_num`, `is_page_size`, `sort`, `create_by`, `create_time`, `update_by`, `update_time`, `deleted`) VALUES (2, 1, 'pageNum', '分页页码', 'INTEGER', 0, '0', '', 1, 0, 0, 1, '2026-07-14 16:01:32', 1, '2026-07-14 16:01:32', 0);
INSERT INTO `sql_define_param` (`id`, `define_id`, `param_name`, `param_desc`, `param_type`, `required`, `default_value`, `drop_down`, `is_page_num`, `is_page_size`, `sort`, `create_by`, `create_time`, `update_by`, `update_time`, `deleted`) VALUES (3, 1, 'pageSize', '', 'INTEGER', 0, '30', '', 0, 1, 0, 1, '2026-07-14 16:01:52', 1, '2026-07-14 16:01:52', 0);
...
CREATE TABLE `cw_approval` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '审批单号',
  `type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '审批类型：REFUND 等',
  `session_id` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '关联会话',
  `order_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '关联订单号',
  `amount` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '涉及金额',
  `reason` text COLLATE utf8mb4_unicode_ci COMMENT '诉求原因',
  `created_at_ms` bigint NOT NULL COMMENT '创建时间戳（毫秒）',
  `status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'PENDING/APPROVED/DENIED',
  `operator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '决策操作员',
  `decision_note` text COLLATE utf8mb4_unicode_ci COMMENT '决策备注',
  `decided_at_ms` bigint DEFAULT '0' COMMENT '决策时间戳（毫秒）',
  `execution_status` varchar(24) COLLATE utf8mb4_unicode_ci DEFAULT 'NOT_APPLICABLE' COMMENT '下游执行状态',
  `execution_failure_reason` text COLLATE utf8mb4_unicode_ci COMMENT '下游执行失败原因',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='人工审批工单（退款放行等资金动作）';
...
CREATE TABLE `cw_audit_log` (
  ...
  `event_type` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '事件类型: tool-call / final-answer / error',
  `agent_name` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT 'Agent 名称',
  `event_data` text COLLATE utf8mb4_unicode_ci COMMENT '结构化事件字段 JSON',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='合规审计轨迹（结构化存储）';
...
CREATE TABLE `cw_badcase` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'badcase ID（应用赋值的UUID）',
  `source` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '来源：NEGATIVE_FEEDBACK 用户点踩 / QUALITY_FAILURE 质检不过',
  `session_id` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '所属会话',
  `message_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '被反馈的消息ID（质检来源为空，质检针对一批回复）',
  `user_input` text COLLATE utf8mb4_unicode_ci COMMENT '用户问了什么（从聊天留痕回查）',
  `agent_reply` text COLLATE utf8mb4_unicode_ci COMMENT 'AI答了什么（从聊天留痕回查）',
  `signal_hash` char(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '归一化用户问题SHA-256，供上线复发观测',
  `detail` text COLLATE utf8mb4_unicode_ci COMMENT '原始信号明细：点踩存用户留言，质检存得分与扣分项',
  `status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING' COMMENT '状态：PENDING 待筛/RESOLVED 已处理/IGNORED 已忽略',
  `adopted_knowledge_id` bigint DEFAULT NULL COMMENT '已回流成的知识条目ID（cw_knowledge.id）',
  `adopted_eval_case_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '已回流成的评测用例编号（cw_eval_case.case_id）',
  `handled_by` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '处理人',
  `handled_at_ms` bigint DEFAULT NULL COMMENT '处理时间戳（毫秒）',
  `ignore_reason` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '忽略原因（仅 IGNORED 时有值）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='badcase 待筛队列（回流知识库/评测用例）';
...
CREATE TABLE `cw_chat_attachment` (
  ...
  `uploader` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '上传者标识',
  `channel` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '来源渠道:user_chat/admin_chat/vibecoding',
  ...
  `parsed_text` mediumtext COLLATE utf8mb4_unicode_ci COMMENT '解析出的文本',
  `error_message` varchar(512) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '解析失败原因',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='对话附件';
...
CREATE TABLE `cw_chat_message` (
  ...
  `message_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '业务消息号 MSG-<uuid>',
  `session_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '所属会话',
  `ticket_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '关联工单号（可空）',
  `sender_type` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '发送方类型 USER/BOT/AGENT/SYSTEM',
  `sender_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '发送方标识（可空）',
  `content` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '消息内容',
  `created_at_ms` bigint NOT NULL COMMENT '创建时间戳（毫秒）',
  `answer_evidence` json DEFAULT NULL COMMENT '答复终态、来源线索、任务进度及实际检索引用',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='会话/工单聊天消息留痕';
...
CREATE TABLE `cw_complaint` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `complaint_no` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '投诉工单号',
  `order_id` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '关联订单号（可空）',
  `content` text COLLATE utf8mb4_unicode_ci COMMENT '投诉内容',
  `status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '状态：PROCESSING/RESOLVED',
  `created_at_ms` bigint NOT NULL COMMENT '创建时间戳（毫秒）',
  PRIMARY KEY (`complaint_no`),
  KEY `idx_complaint_order` (`order_id`,`created_at_ms`),
  KEY `idx_complaint_tenant` (`tenant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='投诉工单（JDBC 后端演示表）';
...
CREATE TABLE `cw_csat_survey` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `session_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '会话ID（自然主键：一次会话只该有一次整体评价）',
  `scope_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '运营统计分区键 = 租户码（OpsScopeResolver 取当前租户上下文）',
  `score` tinyint DEFAULT NULL COMMENT '评分 1-5；NULL 表示已邀请未评价（回收率的分母靠它区分）',
  `comment` text COLLATE utf8mb4_unicode_ci COMMENT '文字说明',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='会话级满意度调查（CSAT）';
...
CREATE TABLE `cw_dead_letter` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '死信ID（应用赋值的UUID）',
  `type` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '死信类型：决定由哪个 DeadLetterHandler 重投',
  `payload` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '重投所需的完整载荷（JSON）',
  `biz_key` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '关联业务标识（订单号/会话号），供运营检索',
  `status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING' COMMENT '状态：PENDING 待重投/SUCCEEDED 已成功/ABANDONED 已放弃',
  `attempts` int NOT NULL DEFAULT '0' COMMENT '已重试次数',
  `last_error` text COLLATE utf8mb4_unicode_ci COMMENT '最近一次失败原因',
  `next_retry_at_ms` bigint NOT NULL COMMENT '下次重投时刻（毫秒）',
  `lease_owner` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '当前租约持有实例',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='死信队列（失败操作的兜底重投）';
...
CREATE TABLE `cw_dialog_stage` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `session_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '会话 ID',
  `stage` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '当前对话阶段：GREETING/COLLECTING/PROCESSING/CONFIRMING/ESCALATED',
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '记录创建时间',
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '记录最后修改时间',
  PRIMARY KEY (`session_id`),
  KEY `idx_dialog_stage_tenant` (`tenant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='对话阶段状态机（多实例共享）';
...
CREATE TABLE `cw_dict_item` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `dict_type` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '所属字典类型编码',
  `item_key` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '字典项键（业务值）',
  `item_label` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '字典项标签（展示文案）',
...
CREATE TABLE `cw_dict_type` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `dict_type` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '字典类型编码（如 order_status）',
  `type_name` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '类型名称（展示用）',
  `remark` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '备注说明',
  `enabled` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否启用: 1启用/0停用',
  `created_at_ms` bigint DEFAULT NULL COMMENT '创建时间戳（毫秒）',
  `updated_at_ms` bigint DEFAULT NULL COMMENT '更新时间戳（毫秒）',
...
CREATE TABLE `cw_eval_case` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `eval_type` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '评测类型：INTENT 意图路由 / QUALITY 回复质量',
  `case_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '用例编号（同类型内唯一；与种子同号即覆盖种子）',
  `input` varchar(1024) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '用户输入',
  `expected` varchar(1024) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'INTENT=期望意图（空=期望快车道不命中，交LLM）；QUALITY=期望要点',
  `category` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '归类标签',
  `source` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'MANUAL' COMMENT '来源：SEED 种子/BADCASE 回流/MANUAL 手工',
  `enabled` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否参与评测：0 可屏蔽同号种子用例',
  `origin_ref` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '溯源引用：来自 badcase 时记 badcase ID，便于回看原始会话',
  `created_at_ms` bigint NOT NULL COMMENT '创建时间戳（毫秒）',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_eval_case` (`tenant_id`,`eval_type`,`case_id`),
  KEY `idx_eval_case_tenant` (`tenant_id`,`eval_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='评测用例（种子之外的增量与修正）';
...
CREATE TABLE `cw_eval_run` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `run_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '运行ID（应用赋值的UUID）',
  ...
  `failed_case_ids_json` text COLLATE utf8mb4_unicode_ci COMMENT '失败用例ID的JSON数组（版本间回归识别的依据，不从明细里反解）',
  `failures_json` text COLLATE utf8mb4_unicode_ci COMMENT '失败明细的JSON数组（人读）',
  `metrics_json` text COLLATE utf8mb4_unicode_ci COMMENT '该类型完整原始指标的JSON字典（归一化不丢信息）',
  `trigger_source` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'MANUAL' COMMENT '触发来源：MANUAL/SCHEDULED/API',
  `dataset_size` int NOT NULL DEFAULT '0' COMMENT '评测集规模（用例增删后两次指标不可直接比）',
  `dataset_version_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '本次实际执行的数据集版本',
  `dataset_fingerprint` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '数据集内容SHA-256',
  `version_binding_json` text COLLATE utf8mb4_unicode_ci COMMENT '模型/提示词/Agent/知识/工具/Judge/rubric版本绑定JSON',
  `prompt_fingerprint` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '本次运行时生效的提示词指纹（cw_prompt_version.fingerprint）',
  `remark` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '备注（如"换 qwen-max 后重跑"）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='评测运行记录（只追加，供版本对比）';
...
CREATE TABLE `cw_fact_log` (
  ...
  `scope_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '记忆分区键（TenantResolver 由 sessionId 解析）',
  `fact` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '事实内容',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='事实日志（L3，append-only 审计流水，永不改写）';
...
CREATE TABLE `cw_handoff_ticket` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '工单号',
  `session_id` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '关联会话',
  `reason` text COLLATE utf8mb4_unicode_ci COMMENT '转人工原因',
  `created_at_ms` bigint NOT NULL COMMENT '创建时间戳（毫秒）',
  `status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'PENDING/CLAIMED/RESOLVED',
  `claimed_by` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '接单坐席',
  `claimed_at_ms` bigint DEFAULT '0' COMMENT '接单时间戳（毫秒）',
  `resolution_note` text COLLATE utf8mb4_unicode_ci COMMENT '处理结果备注',
  `resolved_at_ms` bigint DEFAULT '0' COMMENT '结案时间戳（毫秒）',
  `category` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '工单分类（LLM 分类，可空）',
  `required_skill` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '所需坐席技能标签（LLM 分类，可空）',
  `priority` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '优先级 LOW/MEDIUM/HIGH/URGENT（LLM 分类，可空）',
  `emotion` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '用户情绪（LLM 分类，可空）',
  `suggested_assignees` text COLLATE utf8mb4_unicode_ci COMMENT '推荐坐席列表 JSON（HITL 推荐，人工点选非自动派单，可空）',
  PRIMARY KEY (`id`),
  KEY `idx_handoff_status` (`status`),
  KEY `idx_handoff_created` (`created_at_ms`),
  KEY `idx_handoff_ticket_tenant` (`tenant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='人机切换工单（AI 转人工闭环 + 智能分配增强）';
...
CREATE TABLE `cw_harness_memory` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `scope_id` varchar(512) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '记忆归属（workspace 目录路径）',
  `scope_hash` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'scope_id 的 SHA-256（唯一键用，规避 512 字节索引长度限制）',
  `content` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'MEMORY.md 全文',
  `updated_at_ms` bigint NOT NULL COMMENT '更新时间戳（毫秒）',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_harness_memory_scope` (`tenant_id`,`scope_hash`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Harness 分层记忆（MEMORY.md 权威副本）';
...
CREATE TABLE `cw_invoice_request` (
  ...
  `order_id` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '关联订单号',
  `invoice_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '发票抬头',
  `status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING' COMMENT '状态：PENDING/ISSUED',
  `created_at_ms` bigint NOT NULL COMMENT '创建时间戳（毫秒）',
  PRIMARY KEY (`id`),
  KEY `idx_invoice_order` (`order_id`,`created_at_ms`),
  KEY `idx_invoice_request_tenant` (`tenant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='发票申请（JDBC 后端演示表）';
...
CREATE TABLE `cw_knowledge` (
  ...
  `keyword` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '命中关键词（逗号分隔）',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '条目标题',
  `content` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '条目内容',
  `source` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '来源标注',
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '记录创建时间',
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '记录最后修改时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `cw_knowledge_gap` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `question_hash` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '问题原文的 SHA-256',
  `question` varchar(512) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '问题原文（截断保存）——运营要看的就是这个',
  `scope_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '运营统计分区键 = 租户码（OpsScopeResolver 取当前租户上下文）',
...
CREATE TABLE `cw_long_term_memory` (
  ...
  `scope_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '记忆分区键（TenantResolver 由 sessionId 解析）',
  `fact` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '事实内容',
  `scope_hash` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'scope_id + fact 的 SHA-256（去重键，TEXT 无法建唯一索引）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='长期记忆事实（L2，跨会话语义召回）';
...
CREATE TABLE `cw_member` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `member_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '会员ID（对应用户ID）',
  `level` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '会员等级',
  `points` int NOT NULL DEFAULT '0' COMMENT '当前积分',
  `points_expiring` int NOT NULL DEFAULT '0' COMMENT '本月底到期积分',
  `benefits` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '等级权益',
  `next_level` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '下一等级',
  `upgrade_gap` decimal(10,2) DEFAULT '0.00' COMMENT '升级所需再消费金额',
  `phone` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '注册手机号',
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '记录创建时间',
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '记录最后修改时间',
  PRIMARY KEY (`member_id`),
  KEY `idx_member_tenant` (`tenant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='会员（JDBC 后端演示表）';
...
CREATE TABLE `cw_member_account_log` (
  ...
  `issue` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '账户问题描述',
  `handling` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '处置话术',
  `created_at_ms` bigint NOT NULL COMMENT '创建时间戳（毫秒）',
  PRIMARY KEY (`id`),
  KEY `idx_account_log_created` (`created_at_ms`),
  KEY `idx_member_account_log_tenant` (`tenant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='会员账户问题处理日志（JDBC 后端演示表）';
...
CREATE TABLE `cw_memory_consent` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `subject_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '主体类型: USER/SESSION/SERVICE_ACCOUNT',
  `subject_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '租户内主体ID',
  `agent_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Agent稳定标识',
  `scope_id` varchar(68) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '四维主体键SHA-256分区',
  `status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'GRANTED/WITHDRAWN',
  `consent_version` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '用户同意的隐私条款版本',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='长期记忆主体同意记录';
...
CREATE TABLE `cw_message_feedback` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `message_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '被反馈的消息ID',
  `session_id` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '所属会话',
  `type` varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'UP/DOWN',
  `comment` text COLLATE utf8mb4_unicode_ci COMMENT '文字说明',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='消息级用户反馈（点赞/点踩）';
...
CREATE TABLE `cw_order` (
  ...
  `user_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '下单用户',
  `product_id` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '商品ID',
  `product_name` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '商品名称',
  `amount` decimal(10,2) NOT NULL COMMENT '订单金额',
  `status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '订单状态',
  `receiver_addr` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '收货地址',
  `logistics_trace` text COLLATE utf8mb4_unicode_ci COMMENT '物流轨迹',
  `created_at_ms` bigint NOT NULL COMMENT '下单时间戳（毫秒）',
  PRIMARY KEY (`order_id`),
  KEY `idx_order_user` (`user_id`,`created_at_ms`),
  KEY `idx_order_tenant` (`tenant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='订单（JDBC 后端演示表）';
...
CREATE TABLE `cw_outbox_message` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '消息ID，也是下游幂等键',
  `type` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Handler 类型',
  `aggregate_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '聚合根业务标识',
  `payload` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '自包含 JSON 载荷',
  `status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING' COMMENT 'PENDING/PROCESSING/SUCCEEDED/ABANDONED',
  `attempts` int NOT NULL DEFAULT '0' COMMENT '投递失败次数',
  `next_attempt_at_ms` bigint NOT NULL COMMENT '下次投递时间',
  `lease_owner` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '当前租约持有实例',
  `lease_until_ms` bigint NOT NULL DEFAULT '0' COMMENT '租约到期时间',
  `last_error` text COLLATE utf8mb4_unicode_ci COMMENT '最近一次投递错误',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='同库事务 Outbox';
...
CREATE TABLE `cw_product` (
  ...
  `category` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '品类',
  `price` decimal(10,2) NOT NULL COMMENT '价格',
  `stock` int NOT NULL DEFAULT '0' COMMENT '库存',
  `description` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '商品描述',
  `promotion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '优惠活动',
  `status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ON_SALE' COMMENT 'ON_SALE/OFF_SALE',
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '记录创建时间',
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '记录最后修改时间',
  PRIMARY KEY (`product_id`),
  KEY `idx_product_category` (`category`),
  KEY `idx_product_tenant` (`tenant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品（JDBC 后端演示表）';
...
CREATE TABLE `cw_prompt_version` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `fingerprint` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '内容指纹（SHA-256 十六进制前16位）',
  `content` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '提示词全文（归因时比对两版差异）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='提示词版本（运行时实际生效的那份）';
...
CREATE TABLE `cw_rate_limit_rule` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `rule_name` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '规则名（运营可读）',
  `path_prefix` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '匹配的请求路径前缀',
  `dimension` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '计数维度: API_KEY/IP/GLOBAL',
  `limit_count` int NOT NULL COMMENT '窗口内允许的最大请求数',
  `algorithm` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '算法: FIXED_WINDOW/SLIDING_WINDOW',
...
CREATE TABLE `cw_refund` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `refund_no` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '售后工单号',
  `order_id` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '关联订单号',
  `type` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '类型：REFUND/RETURN/EXCHANGE',
  `status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '状态：PENDING/APPROVED/DENIED',
  `amount` decimal(10,2) DEFAULT NULL COMMENT '退款金额（退货/换货可空）',
  `reason` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '诉求原因',
  `new_spec` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '换货目标规格',
  `created_at_ms` bigint NOT NULL COMMENT '创建时间戳（毫秒）',
  PRIMARY KEY (`refund_no`),
  KEY `idx_refund_order` (`order_id`,`created_at_ms`),
  KEY `idx_refund_tenant` (`tenant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='售后工单（JDBC 后端演示表）';
...
CREATE TABLE `cw_seat_agent` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '坐席ID',
  `name` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '坐席名',
  `skills` varchar(512) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '技能标签（逗号分隔，如 refund,invoice）',
  ...
  `seat_group` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '坐席分组',
  `created_at_ms` bigint DEFAULT NULL COMMENT '创建时间戳（毫秒）',
  `updated_at_ms` bigint DEFAULT NULL COMMENT '更新时间戳（毫秒）',
  PRIMARY KEY (`id`),
...
CREATE TABLE `cw_semantic_cache` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离，拦截器自动改写）',
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `scope_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '缓存分区键',
  `config_generation` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'bootstrap' COMMENT '写入时运行配置 contentHash；bootstrap 表示尚未接入热配置',
  `intent` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '意图分类，命中时先按它缩小候选集（关键剪枝）',
  `question` varchar(512) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '原始问题（人读，排查"为什么这条命中了"要看）',
  `question_vector` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '问题向量，逗号分隔浮点数',
  `answer` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '当时的回答',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='语义缓存（仅通用问答，默认关闭）';
...
CREATE TABLE `cw_sensitive_word` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `word` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '敏感词原词面',
  `category` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '类目: POLITICS/PORN/ABUSE/COMPETITOR/CUSTOM',
  `action` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '处置动作: BLOCK/MASK/REVIEW',
  `enabled` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否启用: 1启用/0停用',
  `created_at_ms` bigint DEFAULT NULL COMMENT '创建时间戳（毫秒）',
  `updated_at_ms` bigint DEFAULT NULL COMMENT '更新时间戳（毫秒）',
  PRIMARY KEY (`id`),
...
CREATE TABLE `cw_sensitive_word_hit_log` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `direction` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '命中方向: INBOUND用户输入/OUTBOUND模型输出',
  `action` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '整体决策: BLOCK/MASK/REVIEW',
  `words` varchar(512) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '命中词面，逗号分隔',
  `categories` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '命中类目，逗号分隔已去重',
  `hit_count` int NOT NULL DEFAULT '0' COMMENT '命中词个数',
  `agent_name` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '智能体名',
  `session_id` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '会话ID',
  `user_id` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '用户ID',
  `snippet` varchar(512) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '原文片段（已按配置截断）',
...
CREATE TABLE `cw_skill` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `skill_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '技能编码（= 落盘目录名）',
  ...
  `description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '技能描述',
  `enabled` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否启用: 1启用/0停用',
  `created_at_ms` bigint DEFAULT NULL COMMENT '创建时间戳（毫秒）',
  `updated_at_ms` bigint DEFAULT NULL COMMENT '更新时间戳（毫秒）',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='技能库（SKILL.md 正文）';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='技能附属文件';
...
CREATE TABLE `cw_slot_filling_progress` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `progress_key` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '收集进度键：sessionId:formName',
  `asking` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '当前追问的槽位名',
  `collected_json` text COLLATE utf8mb4_unicode_ci COMMENT '已收集槽位值（JSON）',
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '记录创建时间',
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '记录最后修改时间',
  PRIMARY KEY (`progress_key`),
  KEY `idx_slot_filling_progress_tenant` (`tenant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='多轮槽位收集进度（如退款表单信息采集）';
...
CREATE TABLE `cw_tenant_quota` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `period` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '周期: DAILY 日 / MONTHLY 月',
  ...
  `exceed_action` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'BLOCK' COMMENT '超额处置: BLOCK 拦截 / DEGRADE 降级备用模型 / WARN 仅告警',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='租户配额（每租户每周期一条）';
...
CREATE TABLE `cw_ticket` (
  `tenant_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default' COMMENT '租户ID（多租户行级隔离）',
  `id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '工单号',
  `session_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '关联会话',
  `user_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '发起用户',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '工单标题',
  `category` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'OTHER' COMMENT '分类',
  `priority` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NORMAL' COMMENT '优先级',
  `status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '状态机状态',
  `assignee` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '当前处理坐席',
  `handoff_reason` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '转人工原因',
  `resolve_note` text COLLATE utf8mb4_unicode_ci COMMENT '处理结论/备注',
  `routing_category` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '智能路由分类原文',
  `required_skill` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '所需坐席技能',
  `routing_priority` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '智能路由优先级原文',
  `emotion` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '用户情绪',
  `suggested_assignees` text COLLATE utf8mb4_unicode_ci COMMENT '推荐坐席列表 JSON',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='客服工单（完整生命周期状态机）';
...
CREATE TABLE `cw_ticket_event` (
  ...
  `ticket_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '所属工单号',
  `event_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '事件类型',
  `from_status` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '流转前状态',
  `to_status` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '流转后状态',
  `actor_type` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '动作发起方类型',
  `actor_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '动作发起方标识',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='工单事件轨迹（不可变审计）';
...
CREATE TABLE `cw_user` (
  ...
  `password_hash` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'BCrypt 密码哈希',
  ...
  `created_at_ms` bigint NOT NULL COMMENT '创建时间戳（毫秒）',
  `avatar_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '头像访问URL（相对路径，可为空）',
  `level_code` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '配额等级编码（空=默认档）',
  `session_epoch` bigint NOT NULL DEFAULT '0' COMMENT '用户会话撤销版本',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_user_username` (`tenant_id`,`username`),
  KEY `idx_user_tenant` (`tenant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='客服系统终端用户账户';
